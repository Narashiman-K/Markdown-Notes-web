    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          // A separate file rather than the same one relabelled. Android crops
          // maskable icons to a circle covering about 80% of the tile, so an
          // icon that fills its square loses its edges; this one has the mark
